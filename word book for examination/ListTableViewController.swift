...
class ListTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let nowIndexPathDictionary: (AnyObject) = questionArray[indexPath.row]
        
        cell.questionLabel.text = nowIndexPathDictionary["question"] as? String
        cell.answerLabel.text = nowIndexPathDictionary["answer"] as? String
